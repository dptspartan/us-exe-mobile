...
export function LetterModule() {
  ...
  return (
    <View style={styles.wrap}>
      <Text style={[styles.kicker, { color: text }]}>Letter</Text>
...
const styles = StyleSheet.create({
  ...
  kicker: { fontSize: 15, fontWeight: '900', letterSpacing: 4, textTransform: 'uppercase' },
  hint: { marginTop: 6, marginBottom: 10, fontSize: 11, paddingRight: 8 },
